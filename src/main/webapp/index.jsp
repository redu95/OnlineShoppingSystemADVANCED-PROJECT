...
<body>
    ...
    <div class ="background">
    	<img class="img-responsive" src="assets/img/home1.jpg" alt="Dummy Image" />
    	<div class="welcome-message">
            "Welcome to Smart Shop, where shopping gets smarter! Discover a world of seamless shopping experiences at your fingertips."
        </div>
        <div class="search-container">
                <form action="products.jsp" method="get">
                    <input type="text" name="productName" class="search-box" placeholder="Search products by name...">
