                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <form role="form" action="AddProducts" method="post"
                                    ...
                                    <div class="form-group">
                                        <label>Price</label> <input class="form-control" type="text" name="productPrice" required/>
                                    </div>
                                    <div class="form-group">
                                        <label>Description</label> <input class="form-control" type="text" style="min-height: 100px;" name="description" required/>
                                    </div>
                                    <div class="form-group">
                                        <label>MRP Price</label> <input class="form-control" type="text" name="mrpPrice" required/>
                                    </div>
                                    <div class="form-group">
                                        <label>Quantity in stock</label> <input class="form-control" type="number" name="productQuantity" required/>
                                    </div>
                                    <div class="form-group">
                                        <label>Status</label> 
